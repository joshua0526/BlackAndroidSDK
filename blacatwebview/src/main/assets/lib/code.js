                    ...
                    BlackCat.ViewTransConfirm.callback = (params, trust, net_fee) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        setTimeout(() => __awaiter(this, void 0, void 0, function* () {
                            try {
                                ...
                                console.log("[BlaCat]", '[main]', 'makeRawTransaction, _makeRawTransaction(params, trust, net_fee, Main.transCallback) error, params => ', params, 'trust =>', trust, 'net_fee =>', net_fee, 'error => ', e.toString());
                            }
                        ...
                        setTimeout(() => __awaiter(this, void 0, void 0, function* () {
                            ...
                            if (Main.transGasCallback) {
                                try {
                                    ...
                                    console.log("[BlaCat]", '[main]', 'makeGasTransfer, app callback error! ViewTransConfirmGas.callback error, params => ', params, 'e => ', e.toString());
                                }
                            }
                        ...
                        setTimeout(() => __awaiter(this, void 0, void 0, function* () {
                            ...
                            if (Main.transGasMultiCallback) {
                                try {
                                    ...
                                    console.log("[BlaCat]", '[main]', 'makeGasTransferMulti, app callback error! ViewTransConfirmGas.callback error, params => ', params, 'e => ', e.toString());
                                }
                            }
...
(function (BlackCat) {
    class PayView extends BlackCat.ViewBase {
        ...
        doMakeRefundOld(id_old, type = "CGAS_OLD") {
            return __awaiter(this, void 0, void 0, function* () {
                if (BlackCat.Main.isWalletOpen()) {
                    ...
                    BlackCat.ViewTransCount.transType = "refund";
                    BlackCat.ViewTransCount.transNncOld = id_OLD;
                    if (type == "CGAS_OLD") {
                        BlackCat.ViewTransCount.coinType = "CGAS";
                    }
                    else if (type == "CNEO_OLD") {
                        BlackCat.ViewTransCount.coinType = "CNEO";
                    }
        ...
        doExchangeToken(coinType = "CGAS") {
            return __awaiter(this, void 0, void 0, function* () {
                if (BlackCat.Main.isWalletOpen()) {
                    BlackCat.ViewTransCount.coinType = coinType;
                    BlackCat.ViewTransCount.transType = "";
                    BlackCat.ViewTransCount.transNncOld = "";
                    BlackCat.ViewTransCount.refer = "PayView";
                    BlackCat.ViewTransCount.callback = () => {
                        switch (BlackCat.ViewTransCount.transType) {
                            case "mint":
                    ...
                    for (let k in this.game_assets) {
                        ...
                        if (this.game_assets[k].hasOwnProperty('coins')) {
                            for (let m in this.game_assets[k]['coins']) {
                                ...
                                balancename.textContent = this.game_assets[k]['coins'][m]['symbol'] ? this.game_assets[k]['coins'][m]['symbol'] : this.allnep5_balance[this.game_assets[k]['coins'][m]['contract']]['symbol'];
...
(function (BlackCat) {
    class ViewTransCount extends BlackCat.ViewBase {
            ...
            if (this.checkBalance()) {
                switch (ViewTransCount.transType) {
                    case "mint":
                        ...
                        switch (ViewTransCount.coinType) {
                            case "CGAS":
        ...
        doConfirm() {
            ...
            if (ViewTransCount.transNncOld != "" && ViewTransCount.transType != "refund") {
        ...
        netFeeChange(net_fee) {
            ...
            if (ViewTransCount.coinType == "CGAS") {
                if (ViewTransCount.transType == "refund") {
        ...
        getCoinBalance() {
            ...
            var coinType_lowcase = ViewTransCount.coinType.toLowerCase();
            if (ViewTransCount.transNncOld == "") {
                this.coinBalance.tat = BlackCat.Main.viewMgr.payView[coinType_lowcase];
            }
            else {
                this.coinBalance.tat = BlackCat.Main.viewMgr.payView[coinType_lowcase + "_old" + ViewTransCount.transNncOld];
            }
        }
        getCoinBalanceLang() {
            ...
            if (ViewTransCount.transNncOld != "" && this.coinBalanceLang.tat != "") {
        ...
        getCoinTypeLang() {
            ...
            if (ViewTransCount.transNncOld != "" && this.coinTypeLang.src != "") {
        ...
        dotransfertype() {
            ...
            this.inputCount.value = "";
            this.inputCount.focus();
            ViewTransCount.transType = this.selectTransfertype.value;
            this.configNetFee();
        }
        configNetFee() {
            var showNetFee = true;
            if (ViewTransCount.transType != "") {
                switch (ViewTransCount.coinType) {
                    case "CGAS":
                        if (ViewTransCount.transNncOld && ViewTransCount.transNncOld == "0x961e628cc93d61bf636dc0443cf0548947a50dbe") {
                            showNetFee = false;
                        }
                        break;
                    case "CNEO":
    ...
    ViewTransCount.coinType = "CGAS";
    ViewTransCount.transType = "";
    ViewTransCount.transNncOld = "";
